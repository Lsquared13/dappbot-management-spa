        ...
        <nav className="navbar navbar-expand-md">
          ...
          <div className={`collapse navbar-collapse ${mobileNavVisible ? " show" : ""}`} id="navbarNav3">
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item">
                  <a className="nav-link" target="_blank" href="https://support.eximchain.com/hc/en-us/categories/360002211513-DappBot" rel="noopener noreferrer">Docs</a>
              </li>
              <li className="nav-item">
                  <a className="nav-link mr-3 mb-2" target="_blank" href="https://support.eximchain.com/hc/en-us/requests/new" rel="noopener noreferrer">Support</a>
              </li>
              <li className="nav-item">
                { loginLogoutLink }
              </li>
