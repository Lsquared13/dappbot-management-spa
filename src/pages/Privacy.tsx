          ...
          <div id="wbars">
            <div className="iub_content legal_pp">
              ...
              <div className="one_line_col">
                ...
                <a href="mailto:support@eximchain.com" rel="noopener noreferrer" target="_blank">support@eximchain.com</a>
              </div> {/* /one_line_col */}
              <div className="one_line_col">
              ...
              <div className="one_line_col">
                ...
                <p>
                  ...
                  Analytics, Heat mapping and session recording and Managing contacts and sending messages.
                </p>
                ...
                <ul className="for_boxes">
                  <li>
                    <div className="box_primary box_10 expand">
                      <h3 className="expand-click w_icon_24 policyicon_purpose_6135504">Analytics</h3>
                  ...
                  <li>
                    <div className="box_primary box_10 expand">
                      <h3 className="expand-click w_icon_24 policyicon_purpose_6135505">Heat mapping and session recording</h3>
                      <div className="expand-content">
                        ...
                        <p>
                          ...
                          Malta
                          –
                          <a href="https://www.hotjar.com/legal/policies/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a> – <a href="https://www.hotjar.com/legal/compliance/opt-out" target="_blank" rel="noopener noreferrer">Opt Out</a>.
                        </p>
                      </div> {/* /expand-content */}
                    </div> {/* /expand */}
                  </li>
